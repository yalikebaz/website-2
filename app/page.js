    ...
    <main className="min-h-screen p-24">
      ...
      <section>
        ...
        <ul>
          ...
          <li>🏃 Developed the front-end for the <a href="https://www.onepeloton.ca/tread/" target="_blank">Peloton treadmill</a> screen interface; selecting their tech stack and data management strategy</li>
